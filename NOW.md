...
**Next:** Merge NGF-Systems-app PR #25 (the Products page) and let it deploy, then merge this repo's PR #5. Then enter the six products on NOMA's client hub → Products card (or leave it to NOMA). Until then the site sells its built-in list, unchanged.
...
**Open PRs:** #5 (products, draft; merge after NGF-Systems-app #25).
